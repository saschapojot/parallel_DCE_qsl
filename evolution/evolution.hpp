...
public:
    ...
    //allocate spaces
        this->psiCurr= new std::complex<double>[N1*N2];
        this->psiTmpCache=new std::complex<double>[N1*N2];
        this->psiNext=new std::complex<double>[N1*N2];
...
public:
    ...
    std::complex<double> * psiCurr;//current value of psi
    std::complex<double> * psiTmpCache;//intermediate value of psi
    std::complex<double> *psiNext;//next value of psi
